...
<body>
    <div class="container-fluid">
        ...
        <footer class="fixed-bottom bg-dark text-light text-center justify-content-center row">
            <a href="#" class="link-light col-12 col-md-4"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-twitter" viewBox="0 0 16 16">
            ...
            <a href="#" class="link-light col-12 col-md-4"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
